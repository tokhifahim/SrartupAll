        ...
        <div className="flex flex-wrap -mx-4 mt-20">
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-3/12 2xl:w-2/12">
            <div className="w-full mb-10">
              ...
              <ul className="space-y-3 ">
                <li>
                  <a href="javascript:void(0)" className="inline-block underline-none text-base leading-loose text-white/70 hover:underline underline-offset-2 hover:text-white">
                    Client support
                  </a>
                </li>
                <li>
                  <a href="javascript:void(0)" className="inline-block text-base underline-none leading-loose text-white/70 hover:underline underline-offset-2 hover:text-white">
                    Latest news
                  </a>
                </li>
                <li>
